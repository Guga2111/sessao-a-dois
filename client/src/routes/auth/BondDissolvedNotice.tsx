...
export function BondDissolvedNotice({ onDismiss }: { onDismiss: () => void }) {
  return (
    <section
      role="status"
      className="mb-6 rounded-2xl border border-coral/28 bg-coral-fade-v px-5 py-4"
    >
      <h2 className="font-display m-0 text-[15px] font-bold tracking-tight text-coral-foreground">
