...
export function AppShellSkeleton() {
  return (
    ...
    >
      <header className="sticky top-0 z-40 flex items-center justify-between gap-6 border-b border-white/[0.07] bg-background/72 px-5 py-4 backdrop-blur-xl sm:px-8">
