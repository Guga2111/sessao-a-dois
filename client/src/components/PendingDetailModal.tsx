    ...
    <Dialog open={open} onOpenChange={handleOpenChange}>
      ...
      >
        ...
        <DialogDescription className="sr-only">
          Ano, nota TMDB, gêneros, onde assistir, sinopse e ações de curtir ou
          passar.
        </DialogDescription>

        {item && (
          <PendingDetailModalContent
            key={item.tmdbId}
            item={item}
            onClose={onClose}
            onLike={onLike}
...
interface PendingDetailModalContentProps {
  item: PendingMatch
  onClose: () => void
  onLike: () => void
  onReject: () => void
...
function PendingDetailModalContent({
  item,
  onClose,
  onLike,
  onReject,
  ...
  actionError,
  onRetryAction,
}: PendingDetailModalContentProps) {
